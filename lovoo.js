...
newElement.innerHTML = '<div id="emojis_by_36_nav"><div id="emojis_by_36_btn_fontsmaller">🡻</div><div id="emojis_by_36_btn_openclose">▼</div><div id="emojis_by_36_btn_fontbigger">🡹</div></div><div id="emojis_by_36_inner"></div>';
...
newElement = '<div id="break" class="emoji_by_36" style="display: block; padding: 5px;">linebreak</div>';
container.innerHTML += newElement; 

emojis = [...new Set(emojis)]; // make unique
...
document.getElementById("emojis_by_36_btn_fontbigger").addEventListener("click", function(e){ 	
	let newvalue = parseInt(window.getComputedStyle(wrapper).fontSize)+1;
	wrapper.style.fontSize = newvalue+"px";
});
